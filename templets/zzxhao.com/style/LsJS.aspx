...
var LR_9c0fe='7B0F7CA84FC34FF9B3D4DFAF6E3DED18';var LR_ssl = 1;
LR_9c0fe=((5+1).toString()+LR_9c0fe+(5*1).toString());var LR_js_pm = 'd';
var LiveReceptionCode_isonline = 1;
LR_9c0fe=((4+2).toString()+LR_9c0fe+(4*2).toString());var LR_766ac=LR_9c0fe.replace(/4/g,'8').replace(/5/g,'3');var LR_lng = 'cn';
var LR_imgurl = 'https://pdt.zoosnet.net/';
var LR_websiteid = 'PDT56482404';
var LR_sysurl = 'https://pdt.zoosnet.net/';
var LR_siteid = '56482404';
var LR_isMobile = 0;
LR_766ac=((4+4).toString()+LR_766ac+(4*4).toString());var LR_OMFM=LR_766ac.replace(/5/g,'6').replace(/7/g,'1');if(typeof(LR_cid) == 'undefined')
{
	...
	var _lr_helpsrc_on=unescape("http%3a%2f%2fpdt.zoosnet.net%2fsite%2f56482404%2fonlineimgsrc_cn.png");
	...
	var _lr_helpsrc_of=unescape("http%3a%2f%2fpdt.zoosnet.net%2fsite%2f56482404%2fonlineimgsrc_cn.png");
	var _lr_closesrc0='1.gif';
	...
	var _lr_invitestring=unescape("%3cP%3e%26nbsp%3b%3c%2fP%3e");
	...
	var LR_pm004=1;
	var LR_pm006='#b7b7b7';
	if(typeof(LR_showminiDivtimeout)=='undefined')var LR_showminiDivtimeout=60;
	var LR_pm007=1;
	var LR_pm011=0;
	var LR_pm012=30;
...
var data='jid='+LR_js_pm+'&id='+LR_siteid+'&sid='+LR_sid+'&cid='+LR_cid+'&lng='+LR_lng;
	data+='&p='+escape(location.href)+'&r='+lr_refer5237+'&e='+escape(LR_explain)+'&NFCC='+LR_OMFM;
...
checkcount=-1;LR_inviteimgJS=0;LR_hcloopJS(LR_sysurl+'js/JS_Float.aspx',data);LR_explain='';
		...
		var minichathtml1=(typeof(minichathtml)!='function');if(minichathtml1)document.write('<link href="https://pdt.zoosnet.net/js/JS5.css" rel="stylesheet" type="text/css" />');
